...
func TestIntegration_RunAndRemove(t *testing.T) {
	...
	// Run a container
	id, err := client.Run(ctx, containerName, "docker.io/library/alpine:latest", nil, []string{"TEST_VAR=hello"})
...
func TestIntegration_RunWithPorts(t *testing.T) {
	...
	id, err := client.Run(ctx, containerName, "docker.io/library/nginx:alpine", ports, nil)
...
func TestIntegration_StopContainer(t *testing.T) {
	...
	_, err := client.Run(ctx, containerName, "docker.io/library/nginx:alpine", nil, nil)
	require.NoError(t, err)
...
func TestIntegration_List(t *testing.T) {
	...
	// Run a container
	_, err := client.Run(ctx, containerName, "docker.io/library/alpine:latest", nil, nil)
	require.NoError(t, err)
